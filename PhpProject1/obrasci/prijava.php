...
if (isset($_GET["submit"])) {
    ...
    $lozinkaSHA = hash('sha256', $lozinka);

    $upit = "SELECT *FROM WebDiP2020x073.korisnik WHERE "
            . "`korisnik_naziv`='{$korime}' AND "
            . "`korisnik_lozinkaSHA`='{$lozinkaSHA}' AND `korisnik_blokiran`<3";
...
<html>
    <head>
        ...
        <meta http-equiv=”Refresh” content=”0;URL=https://barka.foi.hr/WebDiP/2020/zadaca_04/jprga/obrasci/prijava.php>
    ...
    <body id="tijelo">
        ...
        <section id="pocetakPrijave">
            <form name="prijava" id="prijava" method="get" action=prijava.php>
                <div class="popup"><label for="korime">Korisničko ime: </label>
                    <span class="popuptext" id="myPopup0">Unesite svoje korisnicko ime</span></div>
                ...
                <div class="popup"><label for="lozinka">Lozinka: </label>
                     <span class="popuptext" id="myPopup1">3 pogresna unosa lozinke vam blokiraju racun</span></div>
                <input id="lozinka" name="lozinka" type="password"  /><br>
                <div class="popup"><label for="zapamtiMe">Zapamti me: </label>
                    <span class="popuptext" id="myPopup2">Spremite korisnicko ime</span></div>
            ...
            <div class="popup"><a href="../Pomocni/zaboravljenaSifra.php"><p>Zaboravljena sifra?</p></a>
                <span class="popuptext" id="myPopup3">Ponistavanje vase lozinke</span></div>
        </section>
        <footer>
            <a href="https://validator.w3.org/check?uri=http://barka.foi.hr/WebDiP/2020_projekti/WebDiP2020x073/obrasci/prijava.php"><img src="multimedija/HTML5.png" width="50" alt="HTML5"/></a>
