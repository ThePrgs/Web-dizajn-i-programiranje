...
<html>
    ...
    <body>
        ...
        <?php if($postoji) echo "<p>Takav mail ne postoji registriran</p>"; ?>
        <footer>
            <a href="https://validator.w3.org/check?uri=http://barka.foi.hr/WebDiP/2020/zadaca_03/jprga/Pomocni/zaboravljenaSifra.php"><img src="../multimedija/HTML5.png" width="50" alt="HTML5"/></a>
